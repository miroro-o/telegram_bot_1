from users import init_db, get_user, add_user, update_user_status, display_user
from config import token
from dishes import create_table, add_dish, drop_tables, clear_database, get_data  # Импорт необходимых функций
